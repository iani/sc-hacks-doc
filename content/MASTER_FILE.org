...
**** Making sc->emacs available to SuperCollider

The contents of the sc directory needs to be copied to the Extensions directory of your application support directory. You can discover the location of your application support directory by evaluating this in the SuperCollider interpreter:
...
Clone the source to a directory of your choice.  Then copy the supercollider->emacs part in SuperCollider extensions.
...
**** Making emacs->sc available to emacs
...
Are also displayed Testing here.
...
The script was placed in the _scripts directory under the root directory of the site. =[root+]/_scripts/publish_to_ghpages.sh=
