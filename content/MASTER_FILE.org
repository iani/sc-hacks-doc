...
As basic operators, /sc-hacks/ uses four combinations built from + and * with > and <:
...
|----+------------------------+------------------------------------------------------------------------------------------|
|  1 | receiver +> argument   | Play the receiver in the Player named by the argument. 3 types of receivers are accepted |
| 1a | Function               | blah                                                                                     |
| 1b | Event                  | blah                                                                                     |
|  2 | xxx                    | blah                                                                                     |
|----+------------------------+------------------------------------------------------------------------------------------|
